        ...
        <div className="flex w-full md:flex-row flex-col-reverse justify-center items-center px-16 py-8 md:px-28 md:h-screen h-auto">
            {success
                ? <div className="flex flex-col justify-center items-center space-y-4 md:-mt-24" data-aos="fade-in">
                    ...
                    <p className="md:text-3xl text-2xl text-center text-mint-900"><a href="https://wa.me/5493424067248" target="__blank" className="underline">Consulta aqui el precio del envio</a></p>
                </div> 
                :
                <>
                    <span className="flex flex-col md:w-1/2 w-full mt-12 justify-center items-center text-center">
                        ...
                        <p className="text-lg mt-4 text-mint-900 font-regular">Total a pagar: <strong>${total + total / 10}</strong></p>
                    </span>
